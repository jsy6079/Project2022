...
<body>
	...
	<nav class="navbar navbar-default"> 
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class="active"><a href="bbsa.jsp">★동호회 게시판★</a></li>
				<li><a href="bbsb.jsp">★나눔 게시판★</a></li>
			</ul>
			<%
				if(userID == null){
			%>
	...
	<div class="container">
		<div class="row">
			...
			<form method="post" action="replyActiona.jsp?bbsID=<%= bbsID %>">
				<table class="table table-striped"
					...
					<tbody>
						...
						<tr>
				            ...
				            <a href="deleteActionra.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
							</td>
						</tr>
			...
			<br>
			<a href="bbsa.jsp" class="btn btn-primary">목록</a>
			
			<%
				if(userID != null && userID.equals(bbs.getUserID())){
			%>
					<a href="updatea.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">수정</a>
					<a href="deleteActiona.jsp?bbsID=<%= bbsID %>" class="btn btn-primary">삭제</a>
			<%
				}
			%>
		</div>
